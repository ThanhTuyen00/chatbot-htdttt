const chat = {
	...
	25: {
		text: '<strong>Hướng dẫn sử dụng chatbot tư vấn trang phục</strong>'
			...
			+ '<br><strong><i class="far fa-clipboard"></i></strong>: Tùy theo từng <strong>lứa tuổi</strong> của người dùng hệ thống sẽ đưa ra các câu hỏi về <strong>hoàn cảnh</strong> và <strong>phong cách ăn mặc</strong> khác nhau'
			+ '<br><strong><i class="far fa-clipboard"></i></strong>: Tùy theo từng <strong>giới tính</strong> của người dùng hệ thống sẽ đưa ra các câu hỏi về <strong>vóc dáng</strong> khác nhau'
			+ '<br><strong><i class="far fa-clipboard"></i></strong>: Tùy theo từng <strong>hoàn cảnh</strong> của người dùng hệ thống sẽ đưa ra các câu hỏi về <strong>phong cách ăn mặc</strong> khác nhau'
	...
	26: {
		text: '<strong>Số trường hợp của người dùng trong hệ thống</strong>'
			...
			+ '<br><i class="fab fa-pagelines"></i> 1.Nếu lứa tuổi là "Trẻ em" thì có 3 hoàn cảnh: “Đi học”, “Đi chơi, du lịch với gia đình”, “Đi biển”'
			+ '<br><i class="fab fa-pagelines"></i> 2.Nếu lứa tuổi là "Thanh niên" thì có 6 hoàn cảnh: : “Đi chơi, du lịch, dạo phố”, “Đi học”, “Đi biển”, “Đi làm công sở, văn phòng, đi phỏng vấn”, “Đi hội nghị, gặp mặt quan trọng”, “Đi hẹn hò, tiệc cưới, tiệc gia đình”'
			+ '<br><i class="fab fa-pagelines"></i> 3.Nếu lứa tuổi là "Thanh niên" thì có 5 hoàn cảnh: : “Đi chơi, du lịch, dạo phố”, “Đi biển”, “Đi làm công sở, văn phòng, đi phỏng vấn”, “Đi hội nghị, gặp mặt quan trọng”, “Đi hẹn hò, tiệc cưới, tiệc gia đình”'
			+ '<br><strong>Phong cách ăn mặc</strong>: phụ thuộc vào Lứa tuổi, hoàn cảnh của người dùng, có 6 trường hợp'
			+ '<br><i class="fab fa-pagelines"></i> 1. Nếu lứa tuổi là “Trẻ em” hoặc hoàn cảnh là “Đi biển” thì không cần lựa chọn phong cách ăn mặc'
			+ '<br><i class="fab fa-pagelines"></i> 2. Nếu lứa tuổi là “Thanh niên” và hoàn cảnh là “Đi học” thì có các lựa chọn của phong cách là: “Phong cách lịch lãm”, “Phong cách thể thao”'
			+ '<br><i class="fab fa-pagelines"></i> 3. Nếu lứa tuổi là “Thanh niên” và hoàn cảnh là “Đi chơi, du lịch, dạo phố” thì có các lựa chọn của phong cách là: “Phong cách thể thao”, “Phong cách cổ điển”, “Phong cách hiện đại, sành điệu, trẻ trung, năng động”, “Phong cách đường phố, bụi bặm, cá tính, phá cách”'
			+ '<br><i class="fab fa-pagelines"></i> 4. Nếu lứa tuổi là “Trung niên” và hoàn cảnh là “Đi chơi, du lịch, dạo phố” thì có các lựa chọn của phong cách là: “Phong cách lịch lãm”, “Phong cách thể thao”, “Phong cách cổ điển”'
			+ '<br><i class="fab fa-pagelines"></i> 5. Nếu lứa tuổi là “Thanh niên” hoặc “Trung niên” và hoàn cảnh là “Đi làm công sở, văn phòng, đi phỏng vấn” hoặc “Đi hẹn hò, tiệc cưới, tiệc gia đình” thì có các lựa chọn của phong cách là: “Phong cách lịch lãm”, “Phong cách cổ điển”, “Phong cách hiện đại, sành điệu, trẻ trung, năng động”'
			+ '<br><i class="fab fa-pagelines"></i> 6. Nếu lứa tuổi là “Thanh niên” hoặc “Trung niên” và hoàn cảnh là “Đi hội nghị, gặp mặt quan trọng” thì có các lựa chọn của phong cách là: “Phong cách lịch lãm”, “Phong cách cổ điển”'
			+ '<br><strong>Vóc dáng</strong>: phụ thuộc vào lứa tuổi, giới tính của người dùng, có 3 trường hợp'
			+ '<br><i class="fab fa-pagelines"></i> 1. Nếu lứa tuổi của người dùng là “Trẻ em” thì không cần lựa chọn vóc dáng'
			+ '<br><i class="fab fa-pagelines"></i> 2. Nếu lứa tuổi của người dùng khác “Trẻ em” và giới tính là “Nam” thì có 5 kiểu vóc dáng của người dùng: “Dáng hình tam giác”, “Dáng hình tam giác ngược”, “Dáng hình chữ nhật”, “Dáng hình thang”, “Dáng hình bầu dục”'
			+ '<br><i class="fab fa-pagelines"></i> 3. Nếu lứa tuổi của người dùng khác “Trẻ em” và giới tính là “Nữ” thì có 5 kiểu vóc dáng của người dùng: “Dáng hình tam giác”, “Dáng hình tam giác ngược”, “Dáng hình chữ nhật”, “Dáng đồng hồ cát”, “Dáng hình bầu dục”'
			+ '<br><strong>Thể trạng</strong>: phụ thuộc vào lứa tuổi của người dùng, có 2 trường hợp'
			+ '<br><i class="fab fa-pagelines"></i> 1. Nếu lứa tuổi của người dùng là “Trẻ em” thì không cần lựa chọn thể trạng'
			+ '<br><i class="fab fa-pagelines"></i> 2. Nếu lứa tuổi của người dùng khác “Trẻ em” thì có 3 kiểu thể trạng là "Gầy", "Tiêu chuẩn", "Mập"'
			+ '<br><strong>Thời tiết</strong>: phụ thuộc vào hoàn cảnh của người dùng chọn, có 2 trường hợp'
			+ '<br><i class="fab fa-pagelines"></i> 1. Nếu lựa chọn hoàn cảnh của người dùng là “Đi biển” thì người dùng không cần lựa chọn thời tiết'
			+ '<br><i class="fab fa-pagelines"></i> 2. Nếu lựa chọn hoàn cảnh của người dùng khác “Đi biển” thì người dùng có 3 lứa chọn “Nóng”, “Mát mẻ” và “Lạnh”'
	},
	27: {
