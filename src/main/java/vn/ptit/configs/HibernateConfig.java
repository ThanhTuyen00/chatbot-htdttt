...
//		dataSourceConfig.setJdbcUrl("jdbc:mysql://localhost:3306/htdttt1?useUnicode=true&characterEncoding=UTF-8");
//		dataSourceConfig.setUsername("root");
//		dataSourceConfig.setPassword("anhtuyen123");
		dataSourceConfig.setJdbcUrl("jdbc:mysql://us-cdbr-east-05.cleardb.net/heroku_bf8a9f92650c39d?reconnect=true");
		dataSourceConfig.setUsername("b0fce2bc3003c7");
		dataSourceConfig.setPassword("a8663aa6");
